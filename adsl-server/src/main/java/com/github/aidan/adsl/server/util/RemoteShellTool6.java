...
public class RemoteShellTool6 {
    ...
    public RemoteShellTool6(String ipAddr, int port, String userName, String password,
                            String charset) {
        this.ipAddr = ipAddr;
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        RemoteShellTool6 tool = new RemoteShellTool6("157.52.202.19",20300, "root",
                "q123456", "utf-8");
        String result="";
        FileOutputStream fos=new FileOutputStream(new File("H:\\新建文件夹\\log\\log8024.txt"));
